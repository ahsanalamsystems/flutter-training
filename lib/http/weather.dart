...
class WeatherHTTPPage extends StatefulWidget {
...
class _WeatherHTTPPageState extends State<WeatherHTTPPage> {
  ...
  void getWeatherUpdate() async {
    WeatherHTTPService weatherService = WeatherHTTPService();
